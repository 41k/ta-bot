package root.web.rest;

import root.TabotApp;
import root.config.Constants;
import root.domain.User;
import root.repository.AuthorityRepository;
import root.repository.UserRepository;
import root.security.AuthoritiesConstants;
import root.service.UserService;
import root.service.dto.PasswordChangeDTO;
import root.service.dto.UserDTO;
import root.web.rest.vm.KeyAndPasswordVM;
import root.web.rest.vm.ManagedUserVM;
...
import static root.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = TabotApp.class)
